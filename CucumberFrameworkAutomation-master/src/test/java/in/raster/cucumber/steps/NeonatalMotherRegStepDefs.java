...
public class NeonatalMotherRegStepDefs {
    ...
    @Given("^click \"([^\"]*)\" tab$")
    public void clickTab(String newReg) throws Throwable {
    ...
    public void enter_in_the_MrNo_textfield(String MrNo)  {
        motherReg.enterTheValuesInMrNoFields(MrNo);
    }
    ...
    public void enterAndInMotherDetailsInContactFields(String mobileNo, String landLine) throws Throwable {
    ...
    public void enter_in_address_line_doorno_field(String doorNo, int a1)  {
        motherReg.enterTheValueInAddress1Field(doorNo);
    }

    /*Address2 Field*/
    @Then("^enter \"([^\"]*)\" in adddress line(\\d+) streetname field$")
    public void enter_in_adddress_line_streetname_field(String streetName, int a2)  {
        motherReg.enterTheValueInAddress2Field(streetName);
    }

    /*Address3 Field*/
    @Then("^enter \"([^\"]*)\" in address line(\\d+) city field$")
    public void enter_in_address_line_city_field(String city, int a3)  {
    ...
    public void enter_in_address_line_pincode_field(String pinCode, int a4)  {
        motherReg.enterTheValueInaddress4field(pinCode);
    }

    /*Address5 Field*/
    @Then("^enter \"([^\"]*)\" in address line(\\d+) country field$")
    public void enter_in_address_line_country_field(String country, int a5)  {
