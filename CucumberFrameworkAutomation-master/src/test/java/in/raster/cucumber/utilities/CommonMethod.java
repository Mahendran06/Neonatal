...
public final class CommonMethod {
    ...
    /**
     * @param textbox                  this is the webElement of the textbox that you want to clear and enter text
    ...
    /**
     * @param element This is the element where you want to move the mouse cursor
     */
    ...
    /*public static void selectSystemDateAndTime(){
